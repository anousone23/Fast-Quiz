...
import { getAllPayments } from "@/lib/supabase/server/payment";
import RejectPaymentButton from "@/components/RejectPaymentButton";
          ...
          >
            ...
            <div className="flex flex-col items-start gap-y-8">
              ...
              <div className="flex flex-row items-center gap-x-4">
                ...
                <RejectPaymentButton payment={payment} />
              </div>
            </div>
          </div>
        ))}
